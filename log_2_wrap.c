...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__log_2

#else
#  define SWIG_init    init_log_2

#endif
#define SWIG_name    "_log_2"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_log_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:log_2",&obj0)) SWIG_fail;
  {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"log_2", _wrap_log_2, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
